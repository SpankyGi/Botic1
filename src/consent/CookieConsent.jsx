...
const COPY = {
  ca: { intro: 'Utilitzem cookies necessàries per al funcionament del web i, amb el vostre consentiment, cookies d’analítica i màrqueting per entendre’n l’ús i millorar l’experiència.', link: 'Política de cookies', accept: 'Acceptar totes', reject: 'Rebutjar', rejectAll: 'Rebutjar totes', configure: 'Configurar', title: 'Preferències de cookies', save: 'Acceptar selecció', necessary: 'Necessàries', analytics: 'Analítica', marketing: 'Màrqueting', necessaryText: 'Funcionament tècnic, seguretat, idioma i record de la vostra decisió.', analyticsText: 'Google Analytics 4 per entendre l’ús del web.', marketingText: 'Actualment no hi ha eines publicitàries activades.', always: 'Sempre actives', close: 'Tancar preferències' },
  es: { intro: 'Utilizamos cookies necesarias para el funcionamiento de la web y, con su consentimiento, cookies de analítica y marketing para entender su uso y mejorar la experiencia.', link: 'Política de cookies', accept: 'Aceptar todas', reject: 'Rechazar', rejectAll: 'Rechazar todas', configure: 'Configurar', title: 'Preferencias de cookies', save: 'Aceptar selección', necessary: 'Necesarias', analytics: 'Analítica', marketing: 'Marketing', necessaryText: 'Funcionamiento técnico, seguridad, idioma y recuerdo de su decisión.', analyticsText: 'Google Analytics 4 para entender el uso de la web.', marketingText: 'Actualmente no hay herramientas publicitarias activadas.', always: 'Siempre activas', close: 'Cerrar preferencias' },
  en: { intro: 'We use necessary cookies to operate this website and, with your consent, analytics and marketing cookies to understand its use and improve the experience.', link: 'Cookie policy', accept: 'Accept all', reject: 'Reject', rejectAll: 'Reject all', configure: 'Settings', title: 'Cookie preferences', save: 'Accept selection', necessary: 'Necessary', analytics: 'Analytics', marketing: 'Marketing', necessaryText: 'Technical operation, security, language and saving your choice.', analyticsText: 'Google Analytics 4 to understand website use.', marketingText: 'No advertising tools are currently enabled.', always: 'Always active', close: 'Close preferences' },
  fr: { intro: 'Nous utilisons des cookies nécessaires au fonctionnement du site et, avec votre consentement, des cookies d’analyse et de marketing pour comprendre son utilisation et améliorer l’expérience.', link: 'Politique de cookies', accept: 'Tout accepter', reject: 'Refuser', rejectAll: 'Tout refuser', configure: 'Configurer', title: 'Préférences de cookies', save: 'Accepter la sélection', necessary: 'Nécessaires', analytics: 'Analyse', marketing: 'Marketing', necessaryText: 'Fonctionnement technique, sécurité, langue et mémorisation de votre choix.', analyticsText: 'Google Analytics 4 pour comprendre l’usage du site.', marketingText: 'Aucun outil publicitaire n’est actuellement activé.', always: 'Toujours actives', close: 'Fermer les préférences' },
}
